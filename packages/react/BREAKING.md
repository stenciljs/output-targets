...
- Building the generated React component library requires tergeting es2015 at minimum. Projects can set `"target": "es2015"` or higher in their `tsconfig.json` files.
