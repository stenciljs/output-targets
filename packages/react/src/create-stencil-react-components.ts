 ...
 */\n\n`;
  ...
  // For SSR, transformTag must be imported from the hydrate module, not the component library
  // See: https://stenciljs.com/docs/tag-transformation#usage-via-dist-hydrate-script-output-on-a-nodejs-server
  const transformTagImport = transformTag
    ? hydrateModule
      ? `import { transformTag } from '${hydrateModule}';\n`
      : `import { transformTag } from '${stencilPackageName}';\n`
    : '';
...
${transformTagImport}
  ...
  for (const component of components) {
    ...
    serializeShadowRoot${transformTagParam}
  })`;
