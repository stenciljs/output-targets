...
describe('createStencilReactComponents', () => {
  it('should generate a basic react component without events', () => {
    ...
    expect(result).toContain(`import { createLitComponent } from '@stencil/react-output-target/runtime';`);
  ...
  it('should organize and format imports correctly', () => {
    ...
    const createComponentImportIndex = lines.findIndex((line) => line.includes(`import { createLitComponent }`));
