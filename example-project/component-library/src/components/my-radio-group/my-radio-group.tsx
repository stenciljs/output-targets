...
import { renderHiddenInput } from '../helpers';
...
export class RadioGroup implements ComponentInterface {
  ...
  @Element() el!: HTMLMyRadioGroupElement;
   ...
   * @internal
   */
  @Event() myValueChange!: EventEmitter<RadioGroupChangeEventDetail>;
  ...
  private getRadios(): HTMLMyRadioElement[] {
    return Array.from(this.el.querySelectorAll('my-radio'));
  }
  ...
  private emitValueChange(event?: Event) {
    const { value } = this;
    this.myChange.emit({ value, event });
  }
  ...
  onKeydown(ev: KeyboardEvent) {
    ...
    if (ev.target && radios.includes(ev.target as HTMLMyRadioElement)) {
  ...
  render() {
    ...
    return <Host role="radiogroup" aria-labelledby={label ? labelId : null} onClick={this.onClick} class="md"></Host>;
  }
}
