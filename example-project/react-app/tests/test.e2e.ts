import { testScenarios } from 'react-test-components/scenarios';
...
describe('React Vite SSR Integration', () => {
  ...
  // it.skip('should have hydrated component', async () => {
  //   /**
  ...
  //  */
  // it.skip('transforms shadow components rendered as scoped components back to shadow components', async () => {
  //   const pageSource = await browser.getPageSource()
  //   expect(pageSource).toContain('<my-counter class="hydrated"></my-counter>')
  // });

  // it.skip('can interact with transformed components', async () => {
